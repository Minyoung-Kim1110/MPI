...
int main(int argc, char* argv[])
{
    ...
    if(rank == 0){
        ...
        MPI_Gatherv(&value, 1, MPI_INT, buffer, count_array, displacements, MPI_INT, 0, MPI_COMM_WORLD);
        ...
        MPI_Gatherv(&value, 1, MPI_INT, NULL, NULL, NULL, MPI_INT, 0, MPI_COMM_WORLD);
    }else if(rank == 2){
        ...
        MPI_Gatherv(&values[0], 2, MPI_INT, NULL, NULL, NULL, MPI_INT, 0 ,MPI_COMM_WORLD);
